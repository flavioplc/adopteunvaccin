<template>
<div class="container max-w-l min-h-screen mx-auto flex flex-col items-center justify-center px-1">
  <div class="justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
    ...
    <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle" role="dialog" aria-modal="true" aria-labelledby="modal-headline">
        ...
        <div class="sm:flex sm:items-start">
          ...
          <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
            <h3 class="text-lg leading-6 font-medium text-gray-900" id="modal-headline">
              Votre inscription à bien été confirmée !
            </h3>
            <div class="mt-2">
              <p class="text-sm text-gray-500">
                Vous avez été enregistré en tant que volontaire, si un patient se désiste, vous pourrez être contacté.
              </p>
            </div>
          </div>
          </div>
      ...
      <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
        <button type="button" v-on:click="$router.push('/')" class="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-green-600 text-base font-medium text-white hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 sm:ml-3 sm:w-auto sm:text-sm">
